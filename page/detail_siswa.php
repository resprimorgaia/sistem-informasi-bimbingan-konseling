...
<a href="?page=siswa&action=del&kdsis=<?php echo $data['id_siswa']; ?> " style="text-decoration: none;"><button class="btn btn-lg btn-danger btn-block"><i class="fa fa-trash-o"></i> Hapus Data</button></button></a>  
 </div>