...
$total_poin = 0;
$nama_id = $_GET['kdsis']; // GET berfungsi untuk mengambil data yang ada di url
$query = "SELECT * FROM tbl_siswa_pelanggaran where nm_siswa='$nama_id'"; // Tampilkan semua data gambar
...
if($row > 0){ // Jika jumlah data lebih dari 0 (Berarti jika data ada)
    while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
        ...
        echo "<td>".$data['ket']."</td>";
        echo "</tr>";
		$total_poin += $data['poin']; // Tambahkan poin dari setiap baris ke total poin
    }
...
<div>	
<p><b><i>*jumlah poin pelanggaran anda  <?php echo $total_poin; ?> </i></b></p>
</div>
